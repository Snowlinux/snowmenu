...
global mbindkey
# Load the key binding lib (developped by deskbar-applet, copied into snowMenu so we don't end up with an unnecessary dependency)
try:
...
if len(sys.argv) == 2 and sys.argv[1] == "run-in-window":
    ...
    mateapplet.matecomponent_factory("OAFIID:MATE_snowMenu_Factory",
                         mateapplet.Applet.__gtype__,
                         "snowMenu", "0", menu_factory)
